---
title: Changelog
description: Release notes and notable changes for Mobilewright.
slug: /changelog
...
* Chore: upgrade bundled mobilecli to 1.0.8 and use clip for element screenshots ([#289](https://github.com/mobile-next/mobilewright/pull/289), [#290](https://github.com/mobile-next/mobilewright/pull/290))
