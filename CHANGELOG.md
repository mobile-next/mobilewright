## [0.0.58] (2026-09-10)
* Feat: upgrade playwright to 1.63.0 and adapt to internal runner API changes ([#299](https://github.com/mobile-next/mobilewright/pull/299)), thanks to [@marcomaes](https://github.com/marcomaes)
* Feat: add `expect.soft` for non-fatal assertions ([#300](https://github.com/mobile-next/mobilewright/pull/300))
* Feat: update to telemetry upon `mobilewright test` ([#301](https://github.com/mobile-next/mobilewright/pull/301))
